...
Your task is to QA the **RadCore API (v2.3)** — the backend for a radiology information and PACS workstation used by hospital radiology departments.
...
We are more interested in how you approached the problem than in any specific artifact.
